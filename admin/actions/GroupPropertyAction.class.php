<?php
/**
 * @version $Id: GroupPropertyAction.class.php,v 1.3 2007/06/11 04:39:18 minahito Exp $
 */
    ...
    public function _loadActiveBlocks()
    {
        ...
        foreach ([0, 1, 3, 4, 5] as $side) {
            ...
            foreach ($blockArr as $block) {
                if ($block->get('visible') && in_array($block->get('mid'), $t_activeModuleIDs, true)) {
