<?php
/**
 * @version $Id: UserSearchFilterForm.class.php,v 1.1 2007/05/15 02:34:39 minahito Exp $
 */
...
class User_UserSearchFilterForm extends User_AbstractFilterForm
{
    ...
    public function fetch()
    {
        ...
        if (mb_strlen($form->get('lastlog_less')) > 0) {
        ...
        if (mb_strlen($form->get('regdate_more')) > 0) {
        ...
        if (mb_strlen($form->get('regdate_less')) > 0) {
