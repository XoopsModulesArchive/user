...
class User_UserAdminEditForm extends XCube_ActionForm
{
    ...
    public function prepare()
    {
        ...
        $this->mFieldProperties['pass']->setDependsByArray(['maxlength']);
        ...
        $this->mFieldProperties['posts']->setDependsByArray(['required']);
        ...
        $this->mFieldProperties['rank']->setDependsByArray(['required']);
        ...
        $this->mFieldProperties['level']->setDependsByArray(['required']);
    ...
    public function validateUmode()
    {
        if (!in_array($this->get('umode'), ['nest', 'flat', 'thread'], true)) {
