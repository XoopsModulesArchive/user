...
define('_AD_USER_LANG_MAIL_NG_USERS_ONLY', '메일송신에 실패한 사용자만 ');
define('_AD_USER_LANG_MAIL_OK_USERS_ONLY', '메일 송신에 성공한 사용자만');
...
define('_AD_USER_TIP_DELETE_AVATAR', '이 아바타를 사용중인 유저의 아바타는 blank.gif 으로 변경되어졌습니다.');
